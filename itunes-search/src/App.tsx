  ...
  return (
    <>
      <main className="h-screen w-full flex flex-col justify-center items-center">
        <h1 className="bg-gradient-to-r from-fuchsia-400 to-indigo-500 bg-clip-text text-transparent text-5xl font-bold">iTunes Search</h1>
        <div className="flex items-center mt-2 p-1 w-96 border border-gray-200 rounded-lg">
          ...
          <input type="email" placeholder="Search" className="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white pl-11 pr-5 outline-none" />
          <button className="mx-2 bg-gray-200 w-20 h-8 rounded-lg hover:bg-fuchsia-500/60 hover:text-white active:scale-90 active:bg-fuchsia-700 transition-all">Go</button>
        </div>
      </main>
    </>
  )
